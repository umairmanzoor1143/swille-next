		...
		>
			<div className="relative isolate z-0 flex w-full flex-1 scale-y-125 items-center justify-center ">
				...
				<motion.div
					...
					className="-translate-y-[6rem] absolute inset-auto z-30 h-36 w-64 rounded-full bg-orange-100 blur-2xl"
				></motion.div>
				<motion.div
					initial={{ width: "15rem" }}
					...
					className="-translate-y-[7rem] absolute inset-auto z-50 h-0.5 w-[30rem] bg-orange-100"
				></motion.div>
